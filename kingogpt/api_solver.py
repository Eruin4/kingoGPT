...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to the token cache JSON written by kingogpt.token_capture.py.",
    )
    parser.add_argument(
        "--token-config",
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Do not run kingogpt.token_capture.py when the token cache is missing or stale.",
    )
    parser.add_argument(
        "--chat-room-id",
        type=int,
...
def refresh_token_cache(args: argparse.Namespace) -> dict:
    ...
    try:
        ...
        raise RuntimeError(
            "Automatic token refresh requires kingogpt.token_capture.py and Playwright."
        ) from exc
    ...
    result = asyncio.run(kingogpt.token_capture.refresh_token_cache(capture_args))
